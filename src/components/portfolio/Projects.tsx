        ...
        {projects.map((p, i) => (
          ...
          >
            <div className="relative aspect-[4/3] overflow-hidden bg-[var(--navy)]/5">
              ...
              />
              <span className="absolute left-4 top-4 rounded-full bg-white/95 px-3 py-1 text-xs font-medium text-[var(--navy)] backdrop-blur">
                {p.role}
              </span>
            </div>
            <div className="flex flex-1 flex-col p-6">
              ...
              <div className="mt-5 flex items-center gap-2">
                ...
                <a
                  href="#"
                  className="inline-flex items-center gap-1.5 rounded-full border border-border px-4 py-2 text-xs font-semibold text-foreground transition-colors hover:bg-[var(--navy)]/5"
                >
